...
class ChatRequest(BaseModel):
    ...
    query: str = Field(..., min_length=1, max_length=5000, description="User query for report generation")
...
class HumanReviewRequest(BaseModel):
    ...
    decision: str = Field(..., pattern=r"^(approved|rejected|needs_changes)$", description="Review decision")
    comment: Optional[str] = Field(default=None, max_length=1000, description="Optional reviewer comment")
